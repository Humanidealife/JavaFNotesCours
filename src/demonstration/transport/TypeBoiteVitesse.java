...
//  "enum" indique que "demonstration.transport.TypeBoiteVitesse" est une énumération
//Dans ce cas-là, toutes les propriétés dans "demonstration.transport.TypeBoiteVitesse" vont devenir les valeurs de l'énumération "enum"
...
public enum TypeBoiteVitesse {
    ...
    //Par exemple, si l'on veut donner à "demonstration.transport.TypeBoiteVitesse" un attribut sous forme de String qui indique
