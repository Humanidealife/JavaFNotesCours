...
public class Port {
    ...
    //Cette méthode va recevoir en paramètre l'engin qui va venir s'amarrer au pro.wangqian.decouvertejava.demonstration.transport.naval.Port
    ...
    //C'est-à-dire qui implémente au minimum pro.wangqian.decouvertejava.demonstration.transport.Amarrable
    public void accueilDEngin(Amarrable amarrable){
        ...
        //On a besoin de connaître comment ça amarre l'engin au pro.wangqian.decouvertejava.demonstration.transport.naval.Port, donc combien de cordes dont bénéficie
