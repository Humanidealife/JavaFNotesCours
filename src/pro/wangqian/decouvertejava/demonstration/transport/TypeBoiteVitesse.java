...
//  "enum" indique que "pro.wangqian.decouvertejava.demonstration.transport.TypeBoiteVitesse" est une énumération
//Dans ce cas-là, toutes les propriétés dans "pro.wangqian.decouvertejava.demonstration.transport.TypeBoiteVitesse" vont devenir les valeurs de l'énumération "enum"
...
public enum TypeBoiteVitesse {
    ...
    //Par exemple, si l'on veut donner à "pro.wangqian.decouvertejava.demonstration.transport.TypeBoiteVitesse" un attribut sous forme de String qui indique
