...
public class NombreDeCaractereInvalideException extends Exception{
    ...
    public NombreDeCaractereInvalideException() {
    }

    //Il s'agit d'une "String" libre que l'on peut préciser lorsque l'exception survient.
    public NombreDeCaractereInvalideException(String message) {
        super(message);
    }
}
